...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-gray-900">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3 max-w-md">
                ...
                <button
                  ...
                  className="bg-gradient-to-l from-[#4BC0C8] to-[#00bf8f] text-white px-8 py-4 rounded-full font-medium hover:bg-gray-800 dark:hover:bg-gray-600 transition-all hover:scale-105 shadow-lg flex items-center gap-2"
                >
                  Subscribe
                </button>
              </div>
      ...
      <div className="bg-gray-950 dark:bg-gray-950 py-12">
        <div className="container mx-auto px-6 sm:px-12 lg:px-24">
            ...
            <div className="flex items-center gap-6">
              ...
              >
                <svg
                  ...
                  className="w-6 h-6" // smaller than parent circle
                  fill="currentColor"
                >
